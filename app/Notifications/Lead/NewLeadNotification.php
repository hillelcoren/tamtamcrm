...
class NewLeadNotification extends Notification implements ShouldQueue
{
    ...
    public function __construct($lead, $account, $is_system = false)
    {
        ...
        //$this->settings = $lead->customer->getMergedSettings();
    ...
    public function toMail($notifiable)
    {
        $data = [
            ...
            'button' => trans('texts.view_lead'),
            'signature' => $this->account->email_signature,
    ...
    public function toSlack($notifiable)
    {
        ...
        return (new SlackMessage)->success()
            //->to("#devv2")
                                 ->from("System")->image($logo)->content(trans('texts.notification_lead', [
                'client' => $this->lead->present()->name()
            ]));
    }
